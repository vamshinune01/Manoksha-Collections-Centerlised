...
namespace Manoksha.Migrations.Migrations
{
    ...
    [Migration("20260926184423_Phase6ReconciliationHistory")]
    partial class Phase6ReconciliationHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manoksha.Modules.Payments.Domain.ReconciliationHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reconciliation_history");

                    b.HasIndex("ReconciliationId", "OccurredAt")
                        .HasDatabaseName("ix_reconciliation_history_reconciliation_id_occurred_at");

                    b.ToTable("reconciliation_history", "payments");
                });
            ...
            modelBuilder.Entity("Manoksha.Modules.Payments.Domain.ReconciliationHistory", b =>
                {
                    b.HasOne("Manoksha.Modules.Payments.Domain.PaymentReconciliation", null)
                        .WithMany()
                        .HasForeignKey("ReconciliationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reconciliation_history_reconciliations_reconciliation_id");
                });
