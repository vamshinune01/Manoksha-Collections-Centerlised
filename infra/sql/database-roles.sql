...
-- DECLARE s text;
-- BEGIN
--   FOREACH s IN ARRAY ARRAY['platform','identity','audit','settings','branches','employees','catalog','inventory','purchasing','wallet','resellers','pricing','orders'] LOOP
...
--   resellers.reseller_status_changes, resellers.commercial_terms,
--   wallet.ledger_entries, orders.order_lines, orders.order_status_changes FROM manoksha_app;
